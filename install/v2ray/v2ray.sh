...
main() {
    ...
    msgCentrado -verde "installDependent"
    installDependent

    msgCentrado -verde "closeSELinux"
    closeSELinux

    msgCentrado --verde "timeSync"
    timeSync

    msgCentrado --verde "updateProject"
    updateProject

    msgCentrado --verde "profileInit"
    profileInit

    msgCentrado --verde "installFinish"
    installFinish
}
